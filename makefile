...
#
# Copyright	2016 Yizhe Liu 
# License	http://www.gnu.org/licenses/gpl.txt GNU Public License
# Modified Yizhe Liu <yizow@berkeley.edu>
# Author	Steffen Vogel <post@steffenvogel.de>
# Link		http://www.steffenvogel.de
#
# edited for the STM32F1-Discovery
...
BSP_BASE   = stm32vl_discovery

OCDFLAGS   = -f $(OCD_DIR)/board/stm32vldiscovery.cfg
GDBFLAGS   =
...
# Basic HAL libraries
SRCS      += stm32f1xx_hal_rcc.c stm32f1xx_hal_rcc_ex.c stm32f1xx_hal.c stm32f1xx_hal_cortex.c stm32f1xx_hal_gpio.c $(BSP_BASE).c
...
template: cube src
	...
	cp -i $(CUBE_DIR)/Projects/$(BOARD)/$(EXAMPLE)/TrueSTUDIO/$(BOARD)/$(MCU_UC)_FLASH.ld
